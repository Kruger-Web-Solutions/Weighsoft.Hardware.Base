#ifndef TftWeightDisplayService_h
#define TftWeightDisplayService_h
...
class TftWeightDisplayService {
 public:
  TftWeightDisplayService(RemoteWeightService* remoteWeightService);
  void begin();
  void loop();
...
#endif  // TftWeightDisplayService_h
