...
// ─── Constructor ───────────────────────────────────────────────────────────
TftWeightDisplayService::TftWeightDisplayService(RemoteWeightService* remoteWeightService)
...
// ─── begin() ───────────────────────────────────────────────────────────────
void TftWeightDisplayService::begin() {
  // Backlight on FIRST
...
void TftWeightDisplayService::setBacklight(bool on) {
  digitalWrite(TFT_BL, on ? HIGH : LOW);
}

void TftWeightDisplayService::loop() {
...
void TftWeightDisplayService::drawSplash() {
  _tft.fillScreen(COL_BG);
...
void TftWeightDisplayService::drawWeightScreen(const String& weight, const String& line, bool connected) {
  _tft.fillScreen(COL_BG);
...
// ─── Status bar ────────────────────────────────────────────────────────────
void TftWeightDisplayService::drawStatusBar(bool connected, unsigned long ageMs) {
...
// ─── Large weight number ────────────────────────────────────────────────────
void TftWeightDisplayService::drawWeightValue(const String& weight, bool connected) {
...
void TftWeightDisplayService::drawRawLine(const String& line) {
