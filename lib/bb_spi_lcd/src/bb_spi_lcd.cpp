...
#include <esp_psram.h>
#define BB_HAS_ESP_PSRAM 1
#else
#define BB_HAS_ESP_PSRAM 0
#endif
#include <rom/cache.h>
...
{
#ifdef __LINUX__
    linux_qspi_send_cmd(u8CMD, pParams, iLen);
    return;
#endif // __LINUX__
...
{
#ifdef __LINUX__
    linux_qspi_send_data(pData, iLen);
    return;
#endif // __LINUX__
...
void ST77916Init(SPILCD *pLCD, int bVariant)
{
int iCount;
uint8_t *s;
...
const uint8_t st77916_init_b[] = {
  ...
  2,0xF0, 0x00,
  2,0xF0, 0x02,
  15, 0xE0, 0xF0, 0x10, 0x18, 0x0D, 0x0C, 0x38, 0x3E, 0x44, 0x51, 0x39, 0x15, 0x15, 0x30, 0x34,
  15, 0xE1, 0xF0, 0x0F, 0x17, 0x0D, 0x0B, 0x07, 0x3E, 0x33, 0x51, 0x39, 0x15, 0x15, 0x30, 0x34,
  2,0xF0, 0x10,
  2,0xF3, 0x10,
  2,0xE0, 0x08,
  2,0xE1, 0x00,
...
static const uint8_t u8ScrollInit[4] = {0,0,1,16};
    ...
    for (int i=0; i<(int)sizeof(nv3041a_init); i += 2) {
...
#ifdef __LINUX__
    linux_qspi_init(u32Freq, u8D0, u8RST, u8CS, u8CLK);
#endif // __LINUX__
